...
const Player = () => {
    ...
    document.title = `SMWZ | ${moviedet.title}`

    return (
      <>
        <button onClick={()=>history.back()} className='fixed z-10 text-4xl text-black bg-[#0a1016] m-3 md:m-5 rounded-full'><HiChevronLeft /></button>
